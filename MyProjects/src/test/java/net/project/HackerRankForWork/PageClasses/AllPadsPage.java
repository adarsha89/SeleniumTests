...
public class AllPadsPage extends LoadableComponent<AllPadsPage> implements CommonPageInterface{

	WebDriver webDriver=null;
	WebDriverUtilFunctions webDriverUtilFunctions=null;
	public CodePairPage codePairPage=null;
	String url="https://www.hackerrank.com/x/interviews/all";
	...
	public AllPadsPage(WebDriver webDriver) {
	...
	protected void isLoaded() throws Error {
		...
		AppLogger.assertLogEquals(webDriverUtilFunctions.getCurrentUrl(webDriver),url,"AllPadsPage page is not loaded");
